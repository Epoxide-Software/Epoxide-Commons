 ...
 * 
 * Changes include updating the code to run in newer dev environments, and to have extensive
 * documentation.
 */
public class EnumUtils {
    
    /**
     * Instance of Sun's reflection factory. Used to invoke the new field and constructor
     * accessor.
     */
     ...
     * @param target The instance of the object to set the field on. Can be null to specify a
     *        static field.
    ...
    /**
     * Wipes the constants cache from an enum. This sets the enumConstantDirectory and
     * enumConstants (IBM) field to null.
     */
     ...
     * @param additionalParameterTypes An array of classes that represent the additional
     ...
     * @param enumName The name of the enum field to create. Should be all upper cased and
     *        unique.
     * @param ordinal The position of the new enum field.
     * @param additionalTypes An array of classes that represent the additional parameters in
     *        the constructor.
     * @param additionalValues The values for every parameter in the enum constructor.
     ...
     * @param enumName The name of the new field. Should be all upper cased and unique.
     * @param paramTypes An array of classes that represents the additional parameters in the
     *        constructor.
     * @param paramValues The values for every parameter in the enum constructor.
     * @return An object that represents the newly created enum field.
     */
    ...
    public static <T extends Enum<?>> T addEnum (Class<T> enumClass, String enumName, final Class<?>[] paramTypes, Object[] paramValues) {        
        ...
        try {            
            ...
            final T newValue = makeEnum(enumClass, enumName, values.size(), paramTypes, paramValues);
            values.add(newValue);
