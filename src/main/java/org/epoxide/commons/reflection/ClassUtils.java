...
public final class ClassUtils {
    ...
    /**
     * A map linking primitive classes such as int.class to their wrappers, such as Integer.class.
     */
    private final static Map<Class<?>, Class<?>> PRIMITIVE_TO_WRAPPER = createPrimitiveToWrapperMap();
    
    /**
     * A map linking wrapper classes such as Integer.class to their primitive variants, such as int.class.
     */
    ...
    /**
     * Checks if a class is a valid primitive class, within the scope of this system. void.class for example is not primitve.
     * @param clazz The class to check.
    ...
    /**
     * Creates a map which links primitive classes with their wrapper counterparts. This is only used to initially generate {@link #PRIMITIVE_TO_WRAPPER} and {@link #WRAPPER_TO_PRIMITIVE}.
