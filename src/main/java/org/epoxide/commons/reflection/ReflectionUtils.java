...
public final class ReflectionUtils {
    ...
    /**
     * Attempts to construct a class using reflection. The constructor used will be determined using the passed object arguments. If no constructor could be found, this will return null and report the error.
    ...
    /**
     * Attempts to find a class constructor from an array of classes which represent the construction argument types being looked for.
    ...
    /**
     * Creates an array of classes which represent the types of the passed objects. The order of types is preserved. 
    ...
    /**
     * A quick utility method for printing class and constructor arguments. Used to make printing the debug info easier. 
